...
<form method="post" style="position: absolute;left: 50%;top: 30px;transform: translate(-50%,0);">
<h1 style="font-size: 50px;font-family: kaiti;margin-left: 22%">研招夏令营信息</h1>
<table border="1" >
<tr>
...
<button type="button" onclick="location.href='../jsp/messBoard.jsp'" style="margin-top: 10%;margin-left:300px;width: 80px;height: 40px;">留言板</button>
</form>
