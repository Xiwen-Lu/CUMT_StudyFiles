...
CREATE TABLE jforum_privmsgs (
  ...
  privmsgs_ENGINE tinyint(4) NOT NULL default '0',
...
CREATE TABLE jforum_topics (
  ...
  topic_ENGINE tinyint(3) default '0',
...
CREATE TABLE jforum_users (
  ...
  user_avatar_ENGINE tinyint(4) NOT NULL default '0',
...
CREATE TABLE jforum_quota_limit (
	...
	quota_ENGINE TINYINT(1) DEFAULT '1'
) ENGINE=InnoDB;
...
CREATE TABLE jforum_banner (
	...
	banner_ENGINE INT NOT NULL DEFAULT '0',
